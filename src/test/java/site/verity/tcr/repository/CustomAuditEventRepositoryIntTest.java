...
import site.verity.tcr.config.audit.AuditEventConverter;
import site.verity.tcr.domain.PersistentAuditEvent;
...
import static site.verity.tcr.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
